function Footer() {
    ...
    <footer className="w-full h-35 bg-gray-300 shadow fixed bottom-0 py-5 ">
        <div className="testimoni flex flex-col md:flex-row items-center mt-2">
            <img className="rounded-full w-20 h-20 object-cover mx-8 my-2 md:my-0" src="./public/static/image/jane.png" alt="Jane Pricilia" />
            ...
            <img className="rounded-full w-20 h-20 object-cover mx-8 my-2 md:my-0" src="./public/static/image/john.png" alt="John Smith" />
            ...
            <img className="rounded-full w-20 h-20 object-cover mx-8 my-2 md:my-0" src="./public/static/image/Sarah.png" alt="Sarah Kim" />
